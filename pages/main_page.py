...
class MainPage(BasePage):
    ...
    def enter_the_search_request(self):
        ...
        search_box.send_keys(MainPageRequests.TENSOR_SEARCH_REQUEST)
    ...
    def go_to_the_search_result_page(self):
        enter = self.browser.find_element(*MainPageLocators.SEARCH_BOX)
    ...
    def go_to_first_link_in_search_results(self):
        ...
        link.click()
        tensor_page_window = self.browser.window_handles[1]
        self.browser.switch_to.window(tensor_page_window)
